 ...
 ****************************************** 
 */
public class CommentEmojiRelativeLayout extends RelativeLayout implements OnItemClickListener, OnClickListener {
    ...
    public CommentEmojiRelativeLayout(Context context) {
        super(context);
        this.context = context;
    }

    public CommentEmojiRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    }

    public CommentEmojiRelativeLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
        case R.id.btn_face:
            CommonUtils.hideSoftInput(context, v);
            // 隐藏表情选择框
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
        ...
        if (emoji.getId() == R.drawable.face_del_icon) {
            ...
            if (selection > 0) {
                ...
                if ("]".equals(text2)) {
                    ...
                    int end = selection;
                    commentEdit.getText().delete(start, end);
                    return;
                }
                commentEdit.getText().delete(selection - 1, selection);
            }
        }
        if (!TextUtils.isEmpty(emoji.getCharacter())) {
            ...
            SpannableString spannableString = EmojiConversionUtil.getInstace().addFace(getContext(), emoji.getId(),
                    emoji.getCharacter());
            commentEdit.append(spannableString);
        }
