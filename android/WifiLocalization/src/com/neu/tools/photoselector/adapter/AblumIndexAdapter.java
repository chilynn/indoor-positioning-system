...
public class AblumIndexAdapter extends BaseAdapter {
	...
	public AblumIndexAdapter(Activity act, List<ImageBucket> list) {
		this.act = act;
		dataList = list;
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		if (arg1 == null) {
			holder = new Holder();
			arg1 = View.inflate(act, R.layout.tools_album_index_item, null);
